...
\begin{table}[H]
	\begin{tabular}{p{5cm}p{2cm}p{5cm}p{5cm}p{6.5cm}}
		...
		\citeauthor{thielen2025dataset} & dataset & m-sequence, de Bruijn sequence, Golay sequence, Gold sequence, Gold code set, modulated & & Binary stimulus sequences, EEG, ECG, SART, resting-state \\
		\bottomrule
	\end{tabular}
\end{table}
