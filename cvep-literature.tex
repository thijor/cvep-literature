...
\newacronym{nrbs}{NRBS}{narrow-band random sequences}
...
\begin{table}[H]
	\begin{tabular}{p{5cm}p{2cm}p{5cm}p{5cm}p{6.5cm}}
		...
		\citeauthor{dehais2024} & preprint & burst codes & \acrshort{cnn} & Grating stimuli, dry \acrshort{eeg} \\
...
\begin{table}[H]
	\begin{tabular}{p{5cm}p{2cm}p{5cm}p{5cm}p{6.5cm}}
		...
		\citeauthor{huang2023} & preprint & white noise & \acrshort{trca} & Visual tracking \\
