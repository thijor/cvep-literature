...
\begin{table}[H]
	\begin{tabular}{p{5cm}p{2cm}p{5cm}p{5cm}p{6.5cm}}
		...
		\citeauthor{thielen2025} & article & modulated Gold codes & reconvolution, \acrshort{cca} & Implanted, invasive, \acrshort{seeg} \\
		\bottomrule
	\end{tabular}
\end{table}
...
\begin{table}[H]
	\begin{tabular}{p{5cm}p{2cm}p{5cm}p{5cm}p{6.5cm}}
		...
		\citeauthor{ahmadi2019} & article & modulated Gold codes & \acrshort{cca} & Number of electrodes, montage \\
